		...
		try {
			...
			if (registration.eventId) {
				toast({
					...
					description: 'Please be patient until the organizer contacts you.',
				})
				setOpen(false)
			}
		} catch (error) {
			...
			if (
				...
				toast({ description: 'You are already registered for this event!' })
				setOpen(false)
			} else {
				toast({ description: 'Something went wrong while registering! 😕' })
			}
		}
	}
